...
const FeatureCard = ({
    ...
    return (
        <div
            className={` w-10/12 mx-auto border-2  backdrop-blur-sm shadow-gradient border-gray-700 p-3 flex flex-col bg-clip-border rounded-xl shadow-md`}
        >
            <div className="w-full mb-3">
                <h3
                    className={`aanimate-bounce-less text-3xl font-semibold ${tagStyle} bg-clip-text text-transparent bg-gradient-to-br from-blue-400 to-purple-400 duration-1000 ease-in-out`}
                >
                    {title}
                </h3>
            </div>
